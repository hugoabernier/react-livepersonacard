...
import { ILivePersonaCardProps } from './ILivePersonaCardProps';
import { ILivePersonaCardState } from './ILivePersonaCardState';
...
export class LivePersonaCard extends React.Component<ILivePersonaCardProps, ILivePersonaCardState> {
  ...
  private _renderOffice365PersonaCard() {
    ...
    const userPrincipalName: string = this.props.user.email ? this.props.user.email : this.props.user.loginName;
